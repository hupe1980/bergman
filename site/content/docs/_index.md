+++
title = "Documentation"
description = "How Bergman measures table health, resolves policy, plans maintenance, and decides — five checks deep — whether a file may be deleted."
sort_by = "weight"
...
states plainly which operations execute today and which are planned-but-blocked,
and why.
